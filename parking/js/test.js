	    ...
	    L.mapbox.accessToken = 'pk.eyJ1IjoibGF1cmVuYW5jb25hIiwiYSI6IkNibGxlRWcifQ.ul9_tiHEKhj52QIfwYjoKA';
	     	...
	     	var map = L.mapbox.map('map','laurenancona.mgb93lh3', {  // set that bounding box as maxBounds to restrict moving the map (http://leafletjs.com/reference.html#map-maxbounds)
			    	maxBounds: bounds,
			    	maxZoom: 19,
			    	minZoom: 12 })
    ...
    // 				}));
	     	...
	     	L.mapbox.config.FORCE_HTTPS = true;
				...
				map.fitBounds(bounds); // zoom/snap the map to bounding box
